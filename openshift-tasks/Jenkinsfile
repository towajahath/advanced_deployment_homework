...
pipeline {
  ...
  //    containerTemplate {
  //      name "jnlp"
  //      image "docker-registry.default.svc:5000/cicd-dev/jenkins-agent-appdev:latest"
  ...
  stages {
    ...
    //************************************************************************************************
    //Uncomment this section below if you want to prompt the User to Manually Approve PROD promotion
    //If promotion is not approved or denied, the pipeline will continue to run before aborting.
    //************************************************************************************************
