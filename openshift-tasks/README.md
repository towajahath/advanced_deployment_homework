# A Sample OpenShift Pipeline for OpenShift Tasks application
...
1. Clone [this repo](https://github.com/chamilton614/ocp_advanced_deployment_homework.git)
2. `cd tasks`
...
At this point you should have 4 projects created (`tasks-build`, `tasks-dev`, `tasks-test`, and `tasks-prod`) with a pipeline in the `-build` project, and the demo app deployed to the dev/test/prod projects.
